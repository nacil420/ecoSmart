      ...
      <div id="product" className="h-auto w-full bg-[#f5f5db] py-[125px] px-8">
        <div className="flex md:flex-row flex-col items-start justify-center gap-8">
          <motion.div
            ...
            animate="onscreen"
            viewport={{ once: true }}
            className="h-full xl:w-[70%] md:w-[80%] w-full border-[3px] border-[#2f7d32] p-8"
          >
            <div className="flex md:flex-row flex-col items-center justify-center gap-4">
              ...
              <div className="h-full xl:w-[50%] md:w-[70%] sm:w-[90%] w-full">
                ...
                <div className="w-[60%]">
                  <Link
                    href={`${linkWa}`}
                    className="bg-[#2f7d32] flex items-center justify-center gap-2 text-slate-100 hover:scale-110 p-4 rounded-md scroll-smooth"
                  >
